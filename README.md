...
- index 쉐어하우스/하우스메이트 최신목록 출력 <br>
  
- 로그인, 로그아웃 (유효성검사) <br>

- 카카오 지도 API , 각 지역의 모집중인 하우스메이트의 클러스터러 <br>

- 모집중인 쉐어하우스의 마커 및 오버레이 <br>

- Node.js 인스턴스 웹 메신저 서버구축 (실시간 채팅, DB연동, 채팅방 나가기, 신고하기), <br>

- 하우스메이트 목록 (페이징, 검색필터 기능 지원) <br>
...
<p>* 기능 시현 보러가기 : https://youtu.be/XGxMIWEITew</p> <br>

https://user-images.githubusercontent.com/76993085/122590291-508fa980-d09c-11eb-80fd-8e323d68d0e5.mp4

<br>
<p>* 다른 구현 기능 보러가기 : </p>
<p>서울메이트 채팅 기능 시현 : https://youtu.be/pWZ4pJBUc0c</p>
<p>서울메이트 채팅 Git : https://github.com/doobyeol/SeoulMateChat</p>
<br>
